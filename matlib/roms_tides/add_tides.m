...
%if nargin<1,
  Fname ='uswc_z20_coamps.nc';  % ROMS forcing and grid files
  Gname ='uswc_z20_grd.nc';
  Ntides=8;                     % Number of tidal constituents 
...
UCLA_system=1;
if UCLA_system,
 SSHr_fname='/disk27/patrickm/TIDES/TPXO.5/H_tpxo/ssh_real.bin';
 SSHi_fname='/disk27/patrickm/TIDES/TPXO.5/H_tpxo/ssh_imag.bin';
 Ur_fname  ='/disk27/patrickm/TIDES/TPXO.5/UV_tpxo/u_real.bin';
 Ui_fname  ='/disk27/patrickm/TIDES/TPXO.5/UV_tpxo/u_imag.bin';
 Vr_fname  ='/disk27/patrickm/TIDES/TPXO.5/UV_tpxo/v_real.bin';
 Vi_fname  ='/disk27/patrickm/TIDES/TPXO.5/UV_tpxo/v_imag.bin';
else,
...
% LON,LAT
% Corner indices as in TPXO.5/H_tpxo/inpar.h
...
disp('Correct astronomical phases & amplitudes for real time runs')
  ...
  hr=0.;
  minute=0.;
  tstart=mjd0+hr/24+minute/(60*24);
  disp(['Start date for nodal correction :',mjd2greg(mjd0)]); 

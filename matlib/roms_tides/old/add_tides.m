function add_tides(Fname,Gname,Ntides)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  This script extract tidal information from simulation data,
%  and write it in forcing file (call wrt_tides)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
IL=81; IM=62;  % Subgrid dimensions
...
Tide.Ephase=-angle(ei(:,:,1:Ntides)).*rad2deg;
Tide.Eamp  = abs(ei(:,:,1:Ntides));

ui_pha     =-angle(ui(:,:,1:Ntides)).*rad2deg;
ui_amp     = abs(ui(:,:,1:Ntides));

vi_pha     =-angle(vi(:,:,1:Ntides)).*rad2deg;

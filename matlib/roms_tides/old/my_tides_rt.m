...
if UCLA_system,
 ...
 Gname='/disk27/patrickm/CONFIG/grid15_z40/usw15_z40_grid.nc';
 Fname='/disk27/patrickm/CONFIG/grid15_z40/usw15_z40_jan-jun02_corr.nc';
 ...
 Gname     ='/users/blaas/ncsa/input_data/usw15_z40_grid.nc';
 Fname     ='/users/blaas/ncsa/input_data/usw15_z40_tides.nc';
...
Ntides  =10;  % Nb of components to write out
...
% check date:
 ...
 disp('t_start: mjd   =      day       month     year')
 disp([mjd,ID,MM,IYYY])

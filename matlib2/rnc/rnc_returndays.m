...
function [daysnum, days, daymonth ]=rnc_returndays(year,month)
%
% (R)oms (N)etcdf files (C)reation package - RNC
%
% [daysnum, days, daymonth]=rnc_returndays(year,month)
%
...
%              daymonth  days 15th of each month
%
...
%
   ...
   for imonth=month
     k=k+1;
     daymonth(k)=datenum(iyear, imonth, 15);
   end
   end

function [cout,H,CS] = ctplt_contourfill(varargin)
%% ctplt_contourfill: Modified version of CONTOURF Filled contour plot  
...
if isstr(varargin{end})
  [lin,col,~,msg] = colstyle(varargin{end});
...
if (min(size(yy))==1),
  [CS]=contours(xx,yy,zz,nv);
else
  [CS]=contours(xx([ 1 1:mz mz],:),yy(:,[1 1:nz nz]),zz,nv);
end;

function [new_data, return_status] = nc_archive_buffer ( input_buffer, ncfile, record_variable, unlimited_dimension )
...
%      unlimited_dimension:
%          Optional.  This should be a coordinate variable.  If not supplied, 
%          the default value is "time".  In ROMS, it is "time".
%   Output:
%      new_data:  
...
% $Id: nc_archive_buffer.m,v 1.11 2005/08/02 13:29:04 johnevans007 Exp $

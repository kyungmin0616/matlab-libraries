...
% $Id: nc_varget.m,v 1.28 2006/01/24 16:14:23 johnevans007 Exp $
...
% 
% Don't assume scaling until we know the necessary attributes exist.
SCALING = 0;
...
[var_name,var_type,nvdims,var_dim,natts]=mexnc('inq_var',ncid,varid);
if status ~= 0
...
if ( status == 0 )
	...
	case 'NC_CHAR'
		...
		%fill_value_indices = findstr(values,fill_value);
		%values(fill_value_indices) = char(0);

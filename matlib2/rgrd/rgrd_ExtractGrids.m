...
function ExtractGrids(inp)

% inp.grdname=grd.grdfile;
%inp.childgrdname='child-grid.nc';
%inp.refinecoeff=3
inp.imin=inp.index(1); 
inp.imax=inp.index(2); 
inp.jmin=inp.index(3); 
inp.jmax=inp.index(4);
%inp.newtopo =0; % if =0 no need to make new topo
%	inp.topofile = 'topography file';
%	inp.nband = 35; % number of points to connect topo
%	inp.rtarget = 0.25; % r maximum value
	
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This  a rearrangment of Pierick's code.  - Manu 
%  Compute the embedded grid
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

CHILD_LEVEL = 3;
refinecoeff = inp.refinecoeff;

%..........................................................

parent_grd =inp.grdname;
child_grd  =inp.childgrdname

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

imin=inp.imin; imax=inp.imax; jmin=inp.jmin; jmax=inp.jmax;

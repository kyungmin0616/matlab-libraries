%RNT_2S
% function temps = rnt_2s(tempz,z_r,depths, [vinterp] )
%
...
%   vinterp=1 (linear) vinterp=2 (cubic), default is cubic
%
% OUTPUT:
...
function fields=rnt_2s(field,z_r,z, varargin)
...
for tile=1:I_TILE*J_TILE
  ...
  tmp=z2scoord_local(field(I,J,:),z_r(I,J,:),z, vinterp);
  fields(I,J,:)=tmp;
...
function Ts = z2scoord_local(Tn,Sn,Zn, vinterp)

function [c99, c95, c12, signi, cpdf_xaxis, cpdf_values]=red_signi(t1,s1,t2,s2,dt,NUM,timescale,varargin);
...
% lowpass
s1=lowpass(s1,1/timescale);
s2=lowpass(s2,1/timescale);
...
for num = 1:NUM
  ...
  s1h=lowpass(detrend(s1h),1/timescale);
  s2h=lowpass(detrend(s2h),1/timescale);

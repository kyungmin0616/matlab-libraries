...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%	monterey(15+5+1.7)
%imin=68; imax=89; jmin=47; jmax=76;
%
%	scalifbight(15+5)
%imin=64; imax=84; jmin=30; jmax=58;
%
%	monterey(15+5)
%imin=40; imax=71; jmin=54; jmax=117;
%
%	scalifbight(20+7)
%imin=43; imax=63; jmin=14; jmax=46;
%
%	scalifbight(20+7+2.3)
%imin=37; imax=58; jmin=31; jmax=73; 
imin=38; imax=58; jmin=33; jmax=73;
%
%	scalifbight(20+7+2.3+0.8)
imin=23; imax=51; jmin=46; jmax=86; 
%
%	scalifbight + Santa Barbara Channel (20+7+2.3)
%imin=24; imax=45; jmin=60; jmax=81;
%
%	calcofi + SCB (9+3)
%imin=58; imax=77; jmin=38; jmax=72;
%
%	calcofi + SCB +SB channel (9+3+1)
%imin=12; imax=46; jmin=24; jmax=62;
%
%	usw + scalifbight + SD Bay off (9+3+1)
imin=40; imax=60; jmin=10; jmax=40;
%
%	usw + scalifbight + SD Bay off + SD hi res (9+3+1)
imin=35; imax=55; jmin=38; jmax=68;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

newtopo = 1; % newtopo =1 if we add and smooth a new topo instead 
             % of simply interpoling the parent one
topofile='/d6/edl/AMR/DATA/topex_SDM2.mat';
rtarget=0.35;%0.15; %r maximum value for the smoothing
...
disp('I am here')
pause
  hnew = smoothgrid(hnew,hmin,rtarget);  % smoothgrid.m
  disp(' ')

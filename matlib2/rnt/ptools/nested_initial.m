...
parent_ini =[CONFIG,'_init.nc',plev];
child_ini  =[CONFIG,'_init.nc',clev];
...
% 3-D fields
%disp('u ...')
%sig2sig(parent_grd,parent_ini,child_grd,child_ini,'u',tindex)
%disp('v ...')
%sig2sig(parent_grd,parent_ini,child_grd,child_ini,'v',tindex)
disp('temp ...')
sig2sig(parent_grd,parent_ini,child_grd,child_ini,'temp',tindex)
disp('salt ...')
sig2sig(parent_grd,parent_ini,child_grd,child_ini,'salt',tindex)
